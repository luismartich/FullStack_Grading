...
<h2 class="my-5">Edit exam results.</h2><br>
    <main><br><br>  
        <form class="in-line" method="post" action= "result.php">
		...
		for ($x = 0; $x <= $len-1; $x++) {
			...
			$a = $user . " - " . $testname;
			echo "<form class='form-in-line' method='post' action='adminresults.php'>";
			echo "<label>".$a."</label>";
			echo "<input type='hidden' id='len' name='len' value='".$len."'>";
			echo "<input type='hidden' id='user' name='user' value='".$user."'>";
			echo "<input type='hidden' id='testname' name='testname' value='".$testname."'>";
